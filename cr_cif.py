...
##################################################################
    ...
    for directory in directories:
        ...
        # Sometimes, '_symmetry_space_group_name_H-M' is written as '_symmetry_space_group_name_H_M'
        # The following 'if' should handle this issue
        if symmetry_group_str is None:
